      ...
      <div class="card-body">
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <select id="filter-duration" v-model.number="filters.maxDuration" class="form-control">
...
const filteredGames = computed(() => {
  ...
  return games.value.filter(game => {
    ...
    if (filters.value.maxDuration && game.durationMinutes > filters.value.maxDuration) return false
    return true
  })
})
